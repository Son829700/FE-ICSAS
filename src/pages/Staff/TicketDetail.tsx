...
const getStepOrder = (type: string): string[] => {
  ...
  return ["CREATED", "APPROVED", "IN_PROGRESS", "RESOLVED", "DONE"];
};
...
export default function TicketDetail() {
  ...
  const isAtFinalStep = ticket.status === finalStep;
          ...
          {terminal ? (
            ...
            <div className="relative flex items-start justify-between overflow-x-auto pb-2">
              ...
              {timelineSteps.map((step, index) => {
                ...
                const isLast = isActive && isAtFinalStep;
                ...
                return (
                  ...
                  >
                    ...
                    {/* Active pulse dot — chỉ khi không phải final step */}
                    {isActive && !isLast && (
