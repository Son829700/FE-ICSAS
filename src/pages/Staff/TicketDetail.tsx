...
/* =======================
   TIMELINE CONFIG
======================= */
type StepKey = "CREATED" | "PENDING" | "APPROVED" | "SOLVED";
...
const TIMELINE_STEPS: {
...
}[] = [
  {
    ...
    description: "User submitted request",
  ...
  },
  {
    key: "APPROVED",
    label: "Approved",
    description: "Assigned to BI staff",
...
const STEP_ORDER: StepKey[] = ["CREATED", "PENDING", "APPROVED", "SOLVED"];
    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
          <h2 className="mb-8 text-lg font-semibold text-gray-800 dark:text-white/90">
            Ticket Progress
          </h2>
          ...
          <div className="relative flex items-start justify-between">
            ...
            {TIMELINE_STEPS.map((step, index) => {
              ...
              const isRejected = ticket.status === "REJECTED" && index === currentStepIndex;
                ...
                >
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-full border-2 ring transition-all
                      ${isRejected
                        ? "border-error-200 bg-error-50 text-error-600 ring-error-200 dark:border-error-800 dark:bg-error-900/40 dark:text-error-400 dark:ring-error-800"
                        : isDone
                  ...
                  >
                    {isActive && ticket.status !== "SOLVED" && ticket.status !== "REJECTED" ? (
          ...
          {ticket.status === "REJECTED" && (
            <div className="mt-6 rounded-xl border border-error-200 bg-error-50 px-4 py-3 dark:border-error-800 dark:bg-error-900/20">
